...
Development: https://github.com/marp-team/marp-cli
...
It is possible to list all of the versions of `marp-cli` available on your platform:
...
```
pixi search marp-cli --channel conda-forge
```
